...
public class NewJFrame extends javax.swing.JFrame {
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(median_button, javax.swing.GroupLayout.PREFERRED_SIZE, 115, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
    ...
    private void new_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_new_buttonActionPerformed
        partialdisplay.setText(" ");
        fulldisplay.setText("Enter Number of Elements");
        //double num[] = new double[w];
        operations = "new";
    ...
    private void enter_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_enter_buttonActionPerformed
        System.out.println("hey");
            ...
            for(int x=0; x<num.length; x++){
                partialdisplay.setText("");
		fulldisplay.setText("Enter element["+(x+1)+"]");
		num[x] = Double.parseDouble(partialdisplay.getText());
	}
        
        w = Integer.parseInt(partialdisplay.getText());
        fulldisplay.setText("");
        fulldisplay.setText("Choose operation: Mean/Median/Mode");
